...
class ModelParser:
    ...
    def read(loader: ResFileSwitchLoader, model: Model):
        ...
        if loader.res_file.version_major2 == 9:
            ...
            model.materials = loader.load_dict_values(Material, material_dict_offs, material_vals_offs)
        else:
            material_vals_offs = loader.read_offset()
            material_dict_offs = loader.read_offset()
            model.materials = loader.load_dict_values(Material, material_dict_offs, material_vals_offs)
        ...
        model.vtx_buffers = loader.load_list(VertexBuffer, num_vtx_buff, int(vtx_array_offs))
